...
app.get('/getObject', (req, res) => {
    ...
    // Nesnenin adını alın (örneğin, locationName + ".png")
    ...
    axios({
        ...
        responseType: "arraybuffer",  // Veriyi tampona almak için responseType'ı ayarla
    })
        ...
        .catch(function (error) {
            console.log(error);
            res.status(500).send("Failed to fetch the object from OBS.");
        });
});
